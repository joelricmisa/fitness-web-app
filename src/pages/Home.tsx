...
import { HomePageText } from "../assets/logos";
import { HomePageGraphic } from "../assets/images";
import { Sponsors } from "../shared/constants";
	...
	return (
		<section
			...
			<motion.div
              ...
              md:ml-40 md:mt-16 md:justify-items-end mt-10 pb-20">
					<img
